...
function create_select_month(svg_calender,select_month,data,info,first_click){
  if(first_click==1){
    ...
    d3.select("#tapBubble").style("display","flex")
  }
    ...
    cell.append("rect")
      ...
      .style("fill", function(){
        if(calendarArray[i]==dayOfMonth){
          ...
          d3.select("#tapBubble").style("top",containerHeight/2+dayHeight*0.6+day_h+'px')
          d3.select("#tapBubble").style("left",containerWidth+dayWidth/2+100+'px')
          return "#DCEBFE"
        }
